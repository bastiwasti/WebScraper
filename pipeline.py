...
from storage import insert_events, insert_raw_summary, create_run, update_run_status_analyzed
...
def run_pipeline(
    ...
    structured_events = analyzer.run(raw_summary, scraper_run_id=scraper_run_id if save_to_db else None)
