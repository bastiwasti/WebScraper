"""Solingen rule parser - fetch and parse Solingen event URLs."""
...
class SolingenRuleParser(BaseRuleParser):
    """Parser for Solingen event pages."""

    @property
    def needs_browser(self) -> bool:
        """Solingen site requires Playwright for dynamic calendar."""
        return True
    ...
    def get_regex_patterns(self) -> List[re.Pattern]:
        """Return regex patterns for Solingen events."""
        patterns = [
    ...
    def _create_event_from_match(self, match: tuple) -> Optional[Event]:
        """Create Event from Solingen regex match."""
        ...
        return Event(
            ...
            date=date,
            time="",
            source="solingen-live.de",
            category="other",
        )

    @classmethod
    def can_handle(cls, url: str) -> bool:
        """Handle Solingen event pages."""
